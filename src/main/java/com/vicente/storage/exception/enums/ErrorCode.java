...
public enum ErrorCode {
    ...
    INVALID_TIMESTAMP_ERROR("InvalidTimestampError", HttpStatus.BAD_REQUEST),
    INVALID_ACCESS_KEY_ERROR("InvalidAccessKeyError", HttpStatus.BAD_REQUEST),
    MISSING_AUTH_HEADER_ERROR("MissingAuthHeaderError", HttpStatus.BAD_REQUEST),
    METHOD_ARGUMENT_NOT_VALID_ERROR("MethodArgumentNotValidError", HttpStatus.BAD_REQUEST),
    CONSTRAINT_VIOLATION_ERROR("ConstraintViolationError", HttpStatus.BAD_REQUEST),
    INVALID_OBJECT_KEY_ERROR("InvalidObjectKeyError", HttpStatus.BAD_REQUEST),
    INVALID_VIRTUAL_FILE_NAME_ERROR("InvalidVirtualFileNameError", HttpStatus.BAD_REQUEST),
    BUCKET_NOT_FOUND_ERROR("BucketNotFoundError", HttpStatus.NOT_FOUND),
    INVALID_SIGNATURE_ERROR("InvalidSignatureError", HttpStatus.UNAUTHORIZED),
    MISSING_ACCESS_KEY_CONTEXT_ERROR("MissingAccessKeyContextError", HttpStatus.UNAUTHORIZED),
    CHECKSUM_MISMATCH_ERROR("ChecksumMismatchError", HttpStatus.UNPROCESSABLE_CONTENT),
    BUCKET_ALREADY_EXISTS_ERROR("BucketAlreadyExistsError", HttpStatus.CONFLICT),
    CRYPTO_SYSTEM_ERROR("CryptoSystemError", HttpStatus.INTERNAL_SERVER_ERROR),
    BUCKET_CREATION_ERROR("BucketCreationError", HttpStatus.INTERNAL_SERVER_ERROR),
    BUCKET_PERSISTENCE_ERROR("BucketPersistenceError", HttpStatus.INTERNAL_SERVER_ERROR),
    ...
    FILE_STREAM_ERROR("FileStreamError", HttpStatus.INTERNAL_SERVER_ERROR),
    ...
    HMAC_ERROR("HMACError", HttpStatus.INTERNAL_SERVER_ERROR),
